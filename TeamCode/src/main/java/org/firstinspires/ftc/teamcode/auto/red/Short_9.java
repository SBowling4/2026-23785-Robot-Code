...
public class Short_9 extends OpMode {
    ...
    private final Pose firstPickupPose = new Pose(16.11552346570397, 84.04332129963899, Math.toRadians(180)).mirror();
    private final Pose secondPickupCP = new Pose(57.357400722021666, 69.48736462093864, Math.toRadians(180)).mirror();
    private final Pose readySecondPickupPose = new Pose(41.761732851985556, 59.610108303249106, Math.toRadians(180)).mirror();
    private final Pose secondPickupPose = new Pose(19.407942238267147, 59.610108303249106, Math.toRadians(180)).mirror();
